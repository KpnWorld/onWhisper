    ...
    async def help_command(
        ...
        try:
            ...
            categories = {
                ...
                "Whispers": [
                    "whisper create - Create a new whisper thread",
                    "whisper close - Close your whisper thread",
                    "whisper delete - Delete a whisper thread (Admin)"
                ],
                "Information": [
            ...
            embed.add_field(
                name="Need help?",
                value="Use `/whisper create` to contact staff for assistance.",
                inline=False
            )
