...
class LoggingCog(commands.Cog):
    ...
    async def create_log_channel(self, guild: discord.Guild) -> discord.TextChannel:
        """Create a unified logging channel"""
        ...
        try:
            channel = await guild.create_text_channel(
                name=channel_name,
                topic="Unified logging channel for all bot events",
